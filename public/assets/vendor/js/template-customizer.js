    ...
    return function () {
        ...
        return function () {
            ...
            var t = s(3379),
                ...
                m = s(7621),
                y = {};
            y.styleTagTransform = p(), y.setAttributes = c(), y.insert = l().bind(null, "head"), y.domAPI = a(), y.insertStyleElement = d(), e()(m.Z, y), m.Z && m.Z.locals && m.Z.locals;
                ...
                L = function () {
                    ...
                    return e = t, s = [{
                        ...
                        value: function () {
                            ...
                            this._cleanup(), this.container = this._getElementFromString(f);
                            ...
                            i.addEventListener("click", o), this._listeners.push([i, "click", o]);
                            var a = this.container.querySelector(".template-customizer-close-btn"),
                                n = function () {
                            ...
                            if (this._hasControls("rtl") && rtlSupport) {
                                ...
                                r.addEventListener("change", c), this._listeners.push([r, "change", c])
                            ...
                            if (this._hasControls("themes")) {
                                ...
                                m.addEventListener("change", y), this._listeners.push([m, "change", y])
                            ...
                            if (this._hasControls("layoutType layoutNavbarFixed layoutFooterFixed layoutMenuFlipped showDropdownOnHover", !0)) {
                                ...
                                if (this._hasControls("layoutType")) {
                                    this._controls.layoutType = b.querySelector(".template-customizer-layouts-options"), this._controls.layoutType.querySelector('input[value="'.concat(this.settings.layoutType, '"]')).setAttribute("checked", "checked");
                                    var _ = function (e) {
                                        return t.setLayoutType(e.target.value)
                                    };
                                    this._controls.layoutType.addEventListener("change", _), this._listeners.push([this._controls.layoutType, "change", _])
                                ...
                                if (this._controls.showDropdownOnHover = this.container.querySelector(".template-customizer-showDropdownOnHover"), this._hasControls("showDropdownOnHover")) {
                                    this._controls.showDropdownOnHover = this._controls.showDropdownOnHover.querySelector("input"), this.settings.showDropdownOnHover && this._controls.showDropdownOnHover.setAttribute("checked", "checked");
                                    var x = function (e) {
                                        return t.setDropdownOnHover(e.target.checked)
                                    };
                                    this._controls.showDropdownOnHover.addEventListener("change", x), this._listeners.push([this._controls.showDropdownOnHover, "change", x])
                                ...
                                if (this._controls.layoutFooterFixedW = this.container.querySelector(".template-customizer-layoutFooterFixed"), this._hasControls("layoutFooterFixed")) {
                                    ...
                                    this._controls.layoutFooterFixed.addEventListener("change", S), this._listeners.push([this._controls.layoutFooterFixed, "change", S])
            ...
            L.THEMES = [{
                ...
                fr: {
                    ...
                    layout_flipped_label: "Menu inversÃ©",
                    layout_dd_open_label: "Liste dÃ©roulante au survol",
                ...
                de: {
                    ...
                    layout_fixed: "Fest",
                    layout_fixed_offcanvas: "AuÃŸerhalb der Leinwand behoben",
                    layout_flipped_label: "MenÃ¼ umgedreht",
                    layout_dd_open_label: "Dropdown beim Hover",
                    layout_navbar_label: "Navigationsleiste behoben",
                    layout_footer_label: "Feste FuÃŸzeile",
                ...
                pt: {
                    ...
                    layout_label: "Esquema (CardÃ¡pio)",
                    layout_static: "EstÃ¡tico",
                    layout_offcanvas: "Offcanvas",
                    layout_fixed: "Fixo",
                    layout_fixed_offcanvas: "Offscreen fixo",
                    layout_flipped_label: "Menu invertido",
                    layout_dd_open_label: "SuspensÃ£o ao passar o mouse",
                    layout_navbar_label: "Barra de navegaÃ§Ã£o fixa",
                    layout_footer_label: "RodapÃ© fixo",
                    misc_header: "DIVERSOS",
                    rtl_label: "DireÃ§Ã£o RTL"
                }
            }
        }(), i
    }()
